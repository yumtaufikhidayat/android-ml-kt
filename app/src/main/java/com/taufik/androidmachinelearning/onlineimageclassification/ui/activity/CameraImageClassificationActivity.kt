...
class CameraImageClassificationActivity : AppCompatActivity() {
    ...
    private val binding by lazy { ActivityCameraImageClassificationBinding.inflate(layoutInflater) }
    ...
    private fun startCamera() {
        ...
        cameraProviderFuture.addListener({
            ...
            try {
                ...
                this.showToast("Gagal memunculkan kamera.")
        ...
        imageCapture.takePicture(
            ...
            object : ImageCapture.OnImageSavedCallback {
                ...
                override fun onError(exc: ImageCaptureException) {
                    this@CameraImageClassificationActivity.showToast("Gagal mengambil gambar.")

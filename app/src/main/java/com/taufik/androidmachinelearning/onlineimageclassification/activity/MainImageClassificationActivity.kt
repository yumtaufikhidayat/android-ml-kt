...
import com.taufik.androidmachinelearning.onlineimageclassification.activity.CameraImageClassificationActivity.Companion.CAMERAX_RESULT
...
class MainImageClassificationActivity : AppCompatActivity() {
    ...
    private fun uploadImage() {
        this.showToast("Fitur ini belum tersedia")
    }
